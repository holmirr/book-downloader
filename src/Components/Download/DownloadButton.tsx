...
export default function DownloadButton({ isDownloading, handleCancel, handleDownload, leftTime, maxPage, isCanceling }: { isDownloading: boolean, handleCancel: () => void, handleDownload: () => void, leftTime: number, maxPage: number, isCanceling: boolean }) {
